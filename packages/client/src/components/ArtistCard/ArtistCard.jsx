...
export default function ArtistCard({ classNames, artistName }) {
  const componentClasses = `${classNames} d-flex flex-column align-items-center artist-card clr-light-20 fx-rounded`;
  ...
  return (
    <div className={componentClasses}>
      ...
      <p className="fnt-input-bold fnt-light text-center m-0 truncate">
        {artistName}
      </p>
    </div>
  );
